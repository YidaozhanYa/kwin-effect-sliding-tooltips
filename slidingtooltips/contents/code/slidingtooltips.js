...
var slidingTooltips = {
    ...
    geometryChange: function (window, oldGeometry) {
        ...
        var blacklist = [
            "plasmashell plasmashell",  // X11
            "plasmashell org.kde.plasmashell", // Wayland
            "latte-dock latte-dock"
        ];

        if (!window.tooltip || (
            (window.windowClass != "plasmashell plasmashell") && (window.windowClass != "plasmashell org.kde.plasmashell")
        )) {
            return;
        }
